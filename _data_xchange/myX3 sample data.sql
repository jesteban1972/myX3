 ...
 * users
 */
INSERT INTO `myX`.`users` (id, username, password, email, birthdate, default_genre, description1, description2, description3, description4, gui_language, results_per_page, lists_order, user_kind) VALUES(
    1,
    "jesteban1972",
...
/**
 * following data belongs to user 2 (Fulano)
 */

/**
 * countries
 */
INSERT INTO `myX`.`countries` (id, name, user_id) VALUES(18, "España", 2);
INSERT INTO `myX`.`countries` (id, name, user_id) VALUES(19, "Francia", 2);
INSERT INTO `myX`.`countries` (id, name, user_id) VALUES(20, "UK", 2);
INSERT INTO `myX`.`countries` (id, name, user_id) VALUES(21, "Israel", 2);
INSERT INTO `myX`.`countries` (id, name, user_id) VALUES(22, "Jordania", 2);

/**
 * kinds
 */
INSERT INTO `myX`.`kinds` (id, name, user_id) VALUES(11, "(genérico)", 2);
INSERT INTO `myX`.`kinds` (id, name, user_id) VALUES(12, "casa particular", 2);
INSERT INTO `myX`.`kinds` (id, name, user_id) VALUES(13, "hotel", 2);
INSERT INTO `myX`.`kinds` (id, name, user_id) VALUES (14, "naturaleza", 2);

/**
 * loca
 */
INSERT INTO `myX`.`loca` (id, achtung, name, rating, is_favorite, address, country, kind, description, coordinates_exact, coordinates_generic, web, user_id) VALUES(
   734,
   null,
 ...
 * practica
 */
INSERT INTO `myX`.`practica` (id, achtung, name, rating, is_favorite, locus_id, date, ordinal, description, tq, tl, user_id) VALUES(
   8279,
   null,
 ...
 * amores
 */
INSERT INTO `myX`.`amores` (id, achtung, alias, rating, is_favorite, genre, description1, description2, description3, description4, web, name, has_photo, phone, email, other, user_id) VALUES(
    5869,
    null,
    "Calíope",
    3,
 ...
 * assignations
 */
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (1, 8279, 5869, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (2, 8280, 5869, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (3, 8281, 5869, 2); /* trio 1/4 */
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (4, 8281, 5870, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (5, 8282, 5869, 2); /* trio 2/4 */
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (6, 8282, 5870, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (7, 8283, 5869, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (8, 8284, 5875, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (9, 8285, 5872, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (10, 8286, 5869, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (11, 8287, 5873, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (12, 8288, 5871, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (13, 8289, 5874, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (14, 8290, 5876, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (15, 8291, 5877, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (16, 8292, 5871, 2); /* trio 3/4 */
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (17, 8292, 5873, 2);
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (18, 8293, 5871, 2); /* trio 4/4 */
INSERT INTO `myX`.`assignations` (id, praxis_id, amor_id, user_id) VALUES (19, 8293, 5873, 2);