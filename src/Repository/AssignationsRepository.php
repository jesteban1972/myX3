 ...
 */
class AssignationsRepository extends ServiceEntityRepository
{
    ...
    public function add(Assignation $entity, bool $flush = false): void
    {
    ...
    public function remove(Assignation $entity, bool $flush = false): void
    {
